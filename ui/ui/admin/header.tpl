                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown tasks-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false" title="{Lang::T('Language')}">
                                <i class="fa fa-flag-o"></i>
                                <span class="hidden-xs">{if $_c['language'] eq 'thai'}TH{else}EN{/if}</span>
                            </a>
                            <ul class="dropdown-menu">
                                <li>
                                    <ul class="menu">
                                        <li>
                                            <a href="{Text::url('settings/language-switch&lang=english')}">
                                                {if $_c['language'] eq 'english'}<span class="glyphicon glyphicon-ok"></span> {/if}{Lang::T('English')}
                                            </a>
                                        </li>
                                        <li>
                                            <a href="{Text::url('settings/language-switch&lang=thai')}">
                                                {if $_c['language'] eq 'thai'}<span class="glyphicon glyphicon-ok"></span> {/if}{Lang::T('Thai')}
                                            </a>
                                        </li>
                                    </ul>
                                </li>
